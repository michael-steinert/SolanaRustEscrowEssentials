...
impl Pack for Escrow {
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        // Using exiting Instance of an Escrow Struct and serialize it into the given DST Slice
        // Slice is simply an Address-Length Pair which should be a fixed Size at Runtime
        let Escrow {
            is_initialized,
            initializer_pubkey,
            temp_token_account_pubkey,
